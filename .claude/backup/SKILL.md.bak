---
name: presentation-design-styles
description: >
  ...
  SciFi Holographic Data, Risograph Print, Soft Pink Card UI (학교사업안내-학부모).
  Also activate for requests using words like "sleek", "modern", "trendy", "designed",
  "stylish", or "visually striking" presentations, or Korean school/education presentations
  like "학부모", "학교 안내", "교육 발표자료".
---
...
3. Apply alongside the core presentation skill to build the slide deck
...
| Education / Research / History | Dark Academia, Nordic Minimalism, Brutalist Newspaper, Soft Pink Card UI |
...
| 31 | Soft Pink Card UI | 따뜻한 · 교육적 | 학부모 안내, 학교 발표 |

---

## Core Production Principles

- **Always use together with the presentation skill** for actual file generation
